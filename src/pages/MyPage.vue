    ...
    <div class="section">
      <div class="container">
        <div class="button-container">
          <a href="#button" class="btn btn-primary btn-round btn-lg">수정하기</a>
          <a
            href="#button"
...
<div class="col-md-8 ml-auto mr-auto text-center">
    ...
    <div class="col-6">
      <drop-down>
        <n-button slot="title" type="primary" simple
    ...
    <card style="width: 30rem;">
      <img slot="image" class="card-img-top" src="https://www.bestcommunitybanks.com/uploads/news-pictures/3-new-york-blog-post-image-20200319104136.jpg" alt="Card image cap">
      <div>
        <h4 class="card-title">내집마련 디딤돌 대출</h4>
        <p class="card-text">정부지원 3대 서민 구입자금을 하나로 통합한 저금리 구입자금대출입니다.</p>
        <strong>대출대상</strong>
        주택매매계약을 체결한 자, 대출신청일 현재 무주택 세대주, 부부합산 연소득 6천만원 이하, 순자산가액 3.94억원 이하인 자
        <br/><strong>대출금리</strong> 연 1.85~2.40%
        <br/><strong>대출한도</strong> 최고 2억원 이내
        <br/><strong>대출기간</strong> 10년, 15년, 20년, 30년
        <br/><n-button type="primary">자세히 보기</n-button>
      </div>
    </card>
