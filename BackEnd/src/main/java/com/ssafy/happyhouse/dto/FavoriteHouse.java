...
public class FavoriteHouse {
	...
	public FavoriteHouse(int favoriteno, String userid, int no, String sidogun, String aptname, String area,
			String dealyearmonth, String dealday, String dealamount, String floor, String buildyear, String roadname,
			int type, String lat, String lng) {
		super();
	...
	public String toString() {
		return "FavoriteHouse [favoriteno=" + favoriteno + ", userid=" + userid + ", no=" + no + ", sidogun=" + sidogun
				+ ", aptname=" + aptname + ", area=" + area + ", dealyearmonth=" + dealyearmonth + ", dealday="
				+ dealday + ", dealamount=" + dealamount + ", floor=" + floor + ", buildyear=" + buildyear
				+ ", roadname=" + roadname + ", type=" + type + ", lat=" + lat + ", lng=" + lng + "]";
	}
