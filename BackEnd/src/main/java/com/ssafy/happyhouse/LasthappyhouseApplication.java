...
public class LasthappyhouseApplication implements WebMvcConfigurer {

	public static void main(String[] args) {
		SpringApplication.run(LasthappyhouseApplication.class, args);
	}
